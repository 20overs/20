    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                <center><i class="fa fa-users fa-3x login-icon"></i></center>
            ...
            <a href="<?=site_url('login')?>" class="text-center new-account">Already have an account ?</a>
        </div>
    </div>
</div>
<style type="text/css">
...
<script type="text/javascript">
    $('#login-form').submit(function(){
        ...
        $.post("<?=site_url()?>welcome/do_register",$(this).serializeArray(),function(data){
            if(data.error == 0)
            {
